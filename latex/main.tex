...
\begin{table}[]
	\begin{tabular}{|l|c|c|c|c|c|}
		\hline
		&Law enforcement& \multicolumn{2}{c|}{Privacy enthusiasts} & \multicolumn{2}{c|}{Data holders} \\ \hline
		&    L $\rightarrow$ P   &       P $\rightarrow$ L         &      P $\rightarrow$ D         &      D $\rightarrow$ L         &     D $\rightarrow$ D           \\ \hline
	Cash 	&  &     \tikzcircle{2pt}      &    \tikzcircle{2pt}     &           &           \\ \hline
	Visa	& \tikzcircle{2pt} &           &           &           &           \\ \hline
